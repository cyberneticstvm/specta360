...
<section class="content-main">
    <div class="content-header">
        ...
        <div class="col-2">
            <a href="{{ route('admin.coupon.create') }}" class="btn btn-submit btn-md btn-brand rounded w-100 font-sm mt-15">Add</a>
        </div>
    </div>
    <div class="row"> 
        <div class="col-lg-12">
                ...
                <table id="dataTable" class="table table-responsive table-sm table-striped">
                    ...
                    @forelse($coupons as $key => $item)
                        <tr>
                            ...
                            <td class="text-center"><a href="{{ route('admin.coupon.edit', encrypt($item->id)) }}" class="btn btn-outline-warning btn-sm">Edit</a></td>
                            <td class="text-center"><a href="{{ route('admin.coupon.cancel', encrypt($item->id)) }}" class="btn btn-outline-danger btn-sm dlt">Delete</a></td>
                        </tr>
                    @empty
                    @endforelse
                </tbody></table>
