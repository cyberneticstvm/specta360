                            ...
                            <div class="detail-info">
                                ...
                                <div class="row">
                                    <div class="col form-group attr-detail attr-color mb-15">
                                        ...
                                        <select class="form-control form-control-sm color-filter" name="color">
                                            <option value="">--Choose Color--</option>
                                        </select>
                                    </div>
                                    <div class="col form-group attr-detail attr-size">
                                        <label class="mr-5">Size</label>
                                        <select class="form-control form-control-sm size-filter" name="size">
                                ...
                                <div class="detail-extralink">
                                    ...
                                    <div class="product-extra-link2">
                                        ...
                                        <a aria-label="Add To Wishlist" class="action-btn hover-up" href="javascript:void(0)"><i class="fi-rs-heart wishList" data-id=""></i></a>
                                        <a aria-label="Compare" class="action-btn hover-up" href="javascript:void(0)"><i class="fi-rs-shuffle compare" data-id=""></i></a>
                                    </div>
                                </div>
                            </div>
                            <!-- Detail Info -->
