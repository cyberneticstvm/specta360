<section class="deals section-padding">
    <div class="container">
        <div class="row">
            ...
            <div class="deal wow fadeIn animated mb-md-4 mb-sm-4 mb-lg-0" style="background-image: url('frontend/assets/imgs/banner/menu-banner-7.jpg');">
                    <div class="deal-top">
            ...
            <div class="col-lg-6 deal-co">
            <div class="deal wow fadeIn animated" style="background-image: url('frontend/assets/imgs/banner/menu-banner-8.jpg');">
                    <div class="deal-top">
