        ...
        <div class="container">
            <div class="row align-items-center height-100vh text-center">
                <div class="col-lg-8 m-auto">
                    <p class="mb-50"><img src="{{ asset('/frontend/assets/imgs/theme/500.png') }}" alt="" class="hover-up"></p>
                    <h2 class="mb-30">Internal Server Error</h2>
                    <p class="font-lg text-grey-700 mb-30">
                    @auth
                    <p class="">Hello {{ Auth::user()->name }}, Something went wrong!</p>
                    @else
                    <p class="">Hello Guest, Something went wrong!</p>
                    @endauth
                    </p>
