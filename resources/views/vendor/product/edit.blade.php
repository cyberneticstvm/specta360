                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        {{ html()->select($name = 'vendor_id', $value = getActiveVendors()->where('id', Auth::user()->id)->pluck('name', 'id'), $product->vendor_id)->class('form-control select2')->placeholder('Select') }}
                                        @error('vendor_id')
                                    ...
                                    <div class="row">
                                        @forelse($product->images as $key => $item)
                                            <div class="col-3 imgs text-center">
                                                ...
                                                <a class="mt-3 dlt" href="{{ route('vendor.product.image.remove', encrypt($item->id)) }}">Remove</a>
                                            </div>
                                        @empty
                                        @endforelse
                                    </div>
