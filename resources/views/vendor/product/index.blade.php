...
<section class="content-main">
    <div class="content-header">
        ...
        <div class="col-2">
            <a href="{{ route('vendor.product.create') }}" class="btn btn-submit btn-md btn-brand rounded w-100 font-sm mt-15">Add</a>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
                ...
                <table id="dataTable" class="table table-responsive table-sm table-striped">
                    ...
                    @forelse($products as $key => $item)
                        <tr>
                            ...
                            <td class="text-center"><a href="{{ route('vendor.product.edit', encrypt($item->id)) }}" class="btn btn-outline-warning btn-sm">Edit</a></td>
                            <td class="text-center"><a href="{{ route('vendor.product.cancel', encrypt($item->id)) }}" class="btn btn-outline-danger btn-sm dlt">Cancel</a></td>
                        </tr>
                    @empty
                    @endforelse
                </tbody></table>
