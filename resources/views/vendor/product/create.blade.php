    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-body mb-4">
                <form method="post" action="{{ route('vendor.product.save') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-8">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        {{ html()->select($name = 'vendor_id', $value = getActiveVendors()->where('id', Auth::user()->id)->pluck('name', 'id'), Auth::user()->id)->class('form-control select2')->placeholder('Select') }}
                                        @error('vendor_id')
