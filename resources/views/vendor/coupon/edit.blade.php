            ...
            <div class="card card-body mb-4">
                <div class="row">
                    <div class="col-12">
                        ...
                        <form method="post" action="{{ route('vendor.coupon.update', $coupon->id) }}">
                            @csrf
                            @method("PUT")
                            <div class="row">
                                <div class="col-3">
                                ...
                                <div class="col-3">
                                    <div class="mb-3">
                                        ...
                                        {{ html()->select($name = 'vendor_id', $data = $vendors, $value = $coupon->vendor_id)->class('form-control select2')->placeholder('Select') }}
                                        @error('vendor_id')
