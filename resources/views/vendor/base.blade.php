...
<body>
    ...
    <aside class="navbar-aside" id="offcanvas_aside">
        ...
        <nav>
            <ul class="menu-aside">
                <li class="menu-item {{ (in_array(request()->segment(2), ['dashboard'])) ? 'active' : '' }}">
                ...
                <ul class="nav">
                    ...
                    <li class="dropdown nav-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownAccount">
                            <a class="dropdown-item" href="{{ route('vendor.dashboard') }}"><strong>Hi, {{ Auth::user()->name }}</strong></a>
                            <a class="dropdown-item" href="{{ route('vendor.profile') }}"><i class="material-icons md-perm_identity"></i>Edit Profile</a>
                            <a class="dropdown-item" href="{{ route('vendor.profile.settings') }}"><i class="material-icons md-settings"></i>Account Settings</a>
